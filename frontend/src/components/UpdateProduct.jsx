      ...
      <div className="container mt-5 col-4 px-4 py-3" style={{ backgroundColor: "hsl(0, 0%, 96%)" }}>
        <form onSubmit={handleUpdate}>
          ...
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="brand" ref={brandRef} placeholder="Enter brand" />
          </div>
          <div className="mb-3">
            <label htmlFor="size" className="form-label">Size</label>
            <input type="number" className="form-control" id="size" ref={sizeRef} placeholder="Enter size" />
          </div>
          <div className="mb-3">
            <label htmlFor="color" className="form-label">Color</label>
            <input type="text" className="form-control" id="color" ref={colorRef} placeholder="Enter color" />
          </div>
          <div className="mb-3">
